...
double min_f(const double a,const double b);
double max_ab(double** U, const int imax, const int jmax);
 ...
 *    free_matrix( U,  0, imax+1, 0, jmax+1 );
 */
//void init_matrix( double **m, int nrl, int nrh, int ncl, int nch, double a, int** flag);
 ...
 *    free_matrix( U,  0, imax+1, 0, jmax+1 );
 */
//void init_imatrix( int **m, int nrl, int nrh, int ncl, int nch, int a, int **flag);
